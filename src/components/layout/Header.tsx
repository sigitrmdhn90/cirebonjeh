...
export function Header({ openCount }: { openCount: number }) {
  return <header className="mobile-header">
    <Link href="/" className="brand"><span className="brand-icon">🍴</span><span className="brand-copy"><strong>Jajan Apa ning Cirebon</strong><small>Jajanan rumahan yang buka hari ini</small></span></Link>
